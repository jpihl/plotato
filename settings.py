# Django settings for plotato project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'plotato',                      # Or path to database file if using sqlite3.
...
SITE_ID = u'4f8e90547bea27128a00001d'
...
MIDDLEWARE_CLASSES = (
    ...
    'plotato.projects.middleware.PermissionDeniedToLoginMiddleware'
)

ROOT_URLCONF = 'plotato.urls'
